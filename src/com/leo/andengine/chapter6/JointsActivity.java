...
//		lineJointDef.initialize(LineJointBodyA, LineJointBodyB, LineJointBodyA.getWorldCenter(), new Vector2(1f,0f));
//		lineJointDef.collideConnected = false;
//		lineJointDef.enableLimit = false;
//		lineJointDef.lowerTranslation = -120f/PhysicsConstants.PIXEL_TO_METER_RATIO_DEFAULT;
//		lineJointDef.upperTranslation = 100f;
...
//		WeldJointRectA.setColor(0f, 0f, 0f);
