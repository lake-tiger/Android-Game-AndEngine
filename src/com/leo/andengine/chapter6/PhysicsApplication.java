package com.leo.andengine.chapter6;
...
public class PhysicsApplication extends BaseGameActivity implements IAccelerationListener, IOnSceneTouchListener {
	...
	public void onPopulateScene(Scene pScene,
		...
		// Further recipes will require us to place code here.
		final Rectangle testBox = new Rectangle(0, 0, 300f, 300f, this.getVertexBufferObjectManager());
		testBox.setColor(0f, 0f, 0f);
		mScene.attachChild(testBox);
