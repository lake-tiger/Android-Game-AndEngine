...
public class ResourceManager extends Object {
	...
	public static HUD ballPotHUD;
	public static TiledTextureRegion faceRedTextureRegion;
	public static TiledTextureRegion faceYellowTextureRegion;
	public static TiledTextureRegion faceBlueTextureRegion;
...
//	        this.ballPotHUD = engine.getCamera().getHUD();
//	    }else {
//	        this.ballPotHUD = new HUD();
//	        engine.getCamera().setHUD(this.ballPotHUD);
//	    }
//		    if(this.receivers instanceof HUD) {
//		        if(this.receivers.equals(null))
//		        System.out.println("receiver is null----------------");
//		    }
	    
	    BitmapTextureAtlasTextureRegionFactory.setAssetBasePath("gfx/");
	    BuildableBitmapTextureAtlas faceTextureAtlas = new BuildableBitmapTextureAtlas(engine.getTextureManager(),128,128);
	    faceRedTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(faceTextureAtlas, context, "face_circle_tiled.png",2,1);
	    faceYellowTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(faceTextureAtlas, context, "face_circle_tiled_yellow.png",2,1);
	    faceBlueTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(faceTextureAtlas, context, "face_circle_tiled_blue.png",2,1);
	    try {
	        faceTextureAtlas.build(new BlackPawnTextureAtlasBuilder<IBitmapTextureAtlasSource, BitmapTextureAtlas>(0, 0, 0));
	        faceTextureAtlas.load();
	    }catch(TextureAtlasBuilderException e) {
	        e.printStackTrace();
	    }
	    
	    BuildableBitmapTextureAtlas mAutoParallaxBackgroundTexture = new BuildableBitmapTextureAtlas(engine.getTextureManager(), 1024, 1024);
        mParallaxLayerFront = BitmapTextureAtlasTextureRegionFactory.createFromAsset(mAutoParallaxBackgroundTexture, context, "parallax_background_layer_front.png");
        mParallaxLayerBack = BitmapTextureAtlasTextureRegionFactory.createFromAsset(mAutoParallaxBackgroundTexture, context, "parallax_background_layer_back.png");
        mParallaxLayerMid = BitmapTextureAtlasTextureRegionFactory.createFromAsset(mAutoParallaxBackgroundTexture, context, "parallax_background_layer_mid.png");
        try {
            mAutoParallaxBackgroundTexture.build(new BlackPawnTextureAtlasBuilder<IBitmapTextureAtlasSource, BitmapTextureAtlas>(0, 0, 0));
