package com.leo.andengine.chapter9.multiplayer;
...
import com.leo.andengine.chapter9.multiplayer.ClientMessages.AddPointClientMessage;
import com.leo.andengine.chapter9.multiplayer.ServerMessages.AddPointServerMessage;
		...
		this.mEngine.runOnUpdateThread(new Runnable(){
			...
			public void run() {
				try {
					...
					MultiplayerClient.this.mServerConnector.registerServerMessage(ServerMessages.SERVER_MESSAGE_ADD_POINT, (Class<? extends IServerMessage>) AddPointServerMessage.class, new IServerMessageHandler<SocketConnection>(){
