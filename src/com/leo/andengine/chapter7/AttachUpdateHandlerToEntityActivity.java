...
public class AttachUpdateHandlerToEntityActivity extends BaseGameActivity implements IOnSceneTouchListener {
...
//		});
	...
	public boolean onSceneTouchEvent(Scene pScene, TouchEvent pSceneTouchEvent) {
		if(pSceneTouchEvent.isActionDown() && !blankEntity.hasParent())
